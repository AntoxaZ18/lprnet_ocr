...
class LPRNet(nn.Module):
    ...
    def __init__(self, 
        ...
        # Layer 1
            ...
            nn.ReLU(),  # Output: (B, 64, H, W)
            nn.MaxPool2d(kernel_size=(3, 3), stride=(1, 1)),  # Output: (B, 64, H', W')

            # Layer 2
            SmallBasicBlock(in_channels=64, out_channels=128),
            nn.BatchNorm2d(num_features=128),
            nn.ReLU(),  # Output: (B, 128, H'', W'')
            nn.Conv2d(128, 64, kernel_size=1), #128->64 pointwise before pooling 
            nn.BatchNorm2d(num_features=64),
            nn.ReLU(),  # Output: (B, 64, H'', W'')
            nn.MaxPool2d(kernel_size=(3, 3), stride=(1, 2)),  # Output: (B, 64, H''', W''')
            ...
            nn.BatchNorm2d(num_features=256),
            nn.ReLU(),  # Output: (B, 256, H'''', W'''')
            nn.Conv2d(256, 96, kernel_size=1), #256->64 pointwise before pooling
            ...
            # Layer 4
            nn.Conv2d(in_channels=96, out_channels=256, kernel_size=(1, 4), stride=1),
            nn.BatchNorm2d(num_features=256),
            nn.ReLU(),
            nn.Dropout(dropout_prob),
            ...
            nn.ReLU(),  # Output: (B, class_num, 1, 1)
        )
